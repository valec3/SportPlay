            ...
            {({ touched, errors }) => (
                <Form className="w-full flex flex-col  px-[30px] bg-primary">
                    ...
                    <ErrorMessage
                        name="last_name"
                        component={() => (
                            <div className="text-[12px] text-warning font-Roboto mx-auto">{errors.last_name}</div>
                        )}
                    />
                    <Field
                        className="text-[16px] md:text-[18px] bg-secondary h-[50px] w-full rounded-xl px-4 my-3"
                    ...
                    <ErrorMessage
                        name="dni"
                        component={() => (
                            <div className="text-[12px] text-warning font-Roboto mx-auto">{errors.dni}</div>
                        )}
                    />
                    <Field
                        className="text-[16px] md:text-[18px] bg-secondary h-[50px] w-full rounded-xl px-4 my-3"
                    ...
                    <ErrorMessage
                        name="email"
                        component={() => (
                            <div className="text-[12px] text-warning font-Roboto mx-auto">{errors.email}</div>
                        )}
                    />
                    ...
                    <p
                        className={` ${
                            errors.password && touched.password ? 'text-warning' : 'text-neutral'
                        } text-[12px] font-Roboto mx-auto`}
                    >
                    ...
                    <div className="p-[30px] mt-5">
                        <div
                            className={` ${
                                submitOk
                                    ? ' w-[43px] h-[43px] m-auto rounded-full '
                                    : 'w-full  text-base-100 text-[18px] font-SourceSansPro text-center font-medium rounded-2xl  cursor-pointer hover:scale-[102%] '
                            } h-[43px] bg-accent flex justify-center items-center transition-all duration-1000`}
                        >
                            {submitOk ? (
                                <FaCheck className=" w-[30px] h-[30px] text-base-100" />
                            ) : (
                                <input className="w-full h-full" value="Registrarme" type="submit" />
                            )}
                        </div>
                    </div>
                    <div className="mx-auto my-5">
                        <p className="text-[14px] md:text-[18px] font-Roboto text-neutral mx-auto">
                            ...
                            <span className="text-success text-[14px] cursor-pointer" onClick={handleLogin}>
                                Inicia Sesión
                            </span>
                        </p>
                    </div>
